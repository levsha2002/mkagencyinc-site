...
const en = {
  ...
  about: {
    ...
    p1: 'M&K Agency Inc. is an family-owned insurance agency headquartered in Florida City and serving families and businesses across the entire state of Florida. We are not a call center — when you call, a licensed agent who knows your name picks up.',
