...
const en = {
  ...
  hero: {
    ...
    strip: "Home, auto, commercial & life coverage — explained by a licensed local agent, all in one place.",
  },
  homeFaq: {
    ...
    items: [
      ...
      { q: 'Do I have to cancel my current policy just to talk to you?', a: "No. We'll review your current coverage with you and explain your options — for home, auto, and every other line we handle. We only recommend a change if it genuinely helps you." },
  ...
  form: {
    ...
    zip: 'ZIP code', name: 'Full name', phone: 'Phone', email: 'Email (optional)',
    message: 'Message (optional)', msgPh: 'Additional details...',
    // Kept for reference; forms render lib/consent.ts (single versioned text).
    ...
    sending: 'Sending...',
    ok: 'Thank you! A licensed agent will call you back during office hours — Mon–Fri, 9am–6pm ET. Need an answer sooner? Ask Nick, our AI assistant, in the chat below.',
  ...
  services: {
    ...
    intro: "We take the time to explain your home coverage so you know exactly what you have. For your car, your business, and the people who depend on you, we'll make sure you have the right protection too.",
    metaTitle: 'Auto, Home & Commercial Insurance in Florida | M&K Agency',
    metaDesc: 'Home, auto, condo, commercial and life insurance from a family-owned agency in Florida City serving all of Florida. Call (305) 859-3953.',
    auto: { h: 'Auto Insurance', p: "Florida drivers pay some of the highest auto rates in the country. We'll explain exactly what your policy covers — liability, full coverage, SR-22, rideshare and more. Same-day proof of insurance available." },
    home: { h: 'Home & Condo Insurance', p: 'Hurricanes, floods, and rising premiums make Florida home insurance complicated. We help you protect your biggest investment and understand exactly what your policy covers — including wind mitigation and four-point inspection guidance.' },
    commercial: { h: 'Commercial Insurance', p: 'From general liability and workers\u2019 comp to commercial auto — we help protect contractors, restaurants, truckers, and small businesses across Florida.' },
    ...
    specialty: { h: 'Other Private Insurance', p: 'Boat, motorcycle, golf cart, pet, and other coverage most standard policies leave out.' },
    cta: 'One call does it all — a licensed agent will walk you through your options.',
  },
  about: {
    metaTitle: 'About M&K Agency | Family-Owned Insurance Agency in Florida City, FL',
    metaDesc: 'M&K Agency Inc. is a bilingual family-owned insurance agency in Florida City serving all of Florida. Real licensed agents, service in English, Spanish and Russian. Call (305) 859-3953.',
  ...
  contact: {
    metaTitle: 'Contact M&K Agency | Talk to a Licensed Agent | (305) 859-3953',
  ...
  referral: {
    ...
    errorMessage: 'Something went wrong. Please call us at (305) 859-3953.',
  ...
  chat: {
    ...
    title: 'Nick AI',
    greeting: "Hi! I'm Nick, the AI assistant at M&K Agency. Ask me anything about auto, home, or business insurance in Florida — or leave your number and a licensed agent will call you back.",
    ...
    cbSending: 'Sending...',
    cbOk: 'Got it! We will call you back during office hours — Mon–Fri, 9am–6pm ET.',
    errMsg: 'Something went wrong. Please call us at (305) 859-3953.',
  },
  // Product quote form on /[lang]/insurance/[slug] (components/InsuranceQuoteForm.tsx).
  quoteForm: {
    title: 'Talk to a licensed agent about {product}',
    sub: 'Takes about a minute. A licensed agent calls you back during office hours (Mon–Fri 9am–6pm ET).',
    name: 'Full name',
    phone: 'Phone',
    email: 'Email (optional)',
    address: 'Address or ZIP code (optional)',
    businessName: 'Business name (optional)',
    businessType: 'Type of business (optional)',
    businessTypePh: 'e.g. landscaping, restaurant, trucking',
    vehicles: 'Number of vehicles (optional)',
    vin: 'VIN (optional)',
    vinPh: '17-character VIN',
    drivers: 'Number of drivers (optional)',
    comments: 'Anything else we should know? (optional)',
    commentsPh: 'e.g. coverages you want, current policy renewal date',
    commentsPhCommercial: 'e.g. what the business does, current policy renewal date, contract requirements',
    submit: 'Request my callback →',
    sending: 'Sending...',
    consentNeeded: 'Please check the consent box above so we can contact you.',
    ok: 'Thank you! A licensed agent will call you back during office hours — Mon–Fri, 9am–6pm ET.',
    err: 'Something went wrong. Please call us at (305) 859-3953.',
    privacy: 'Your info stays private. No spam, ever.',
  },
  // Above-the-fold block on product pages.
  productPage: {
    h1Suffix: 'in Florida',
    callCta: 'Call',
    textCta: 'Text us',
    hours: 'Mon–Fri 9am–6pm ET',
    trustTitle: 'Local, licensed and easy to reach',
    office: 'Office',
  ...
  talkNow: {
    fab: '📲 Talk to an Agent',
    title: 'Have a question about your coverage?',
    sub: 'Request a callback or a text from a licensed agent.',
    callMe: '📞 Call me',
    textMe: '💬 Text me',
    name: 'Your name',
    phone: 'Your phone number',
    agent: 'Prefer a specific agent? (optional)',
    agentAny: 'No preference — any available agent',
    close: 'Close',
    requestCall: 'Request a call →',
    requestText: 'Request a text →',
    sending: 'Sending...',
    okCall: 'Got it! An agent will call you back during office hours — Mon–Fri, 9am–6pm ET.',
  ...
  footerExtra: {
    ...
    allstateBefore: 'Please visit my site, ',
    allstateLink: 'Allstate Agency - Mikhail Kozlov',
    allstateAfter: ', to get more information on the Allstate products and services I can offer.',
  },
  footer: {
    lic: 'M&K Agency Inc. · Family-Owned Insurance Agency · Serving all of Florida',
...
const es: typeof en = {
  ...
  hero: {
    ...
    strip: 'Cobertura de casa, auto, comercial y vida — explicada por un agente local licenciado, todo en un solo lugar.',
  },
  homeFaq: {
    ...
    items: [
      ...
      { q: '¿Tengo que cancelar mi póliza actual solo para hablar con ustedes?', a: 'No. Revisamos con usted su cobertura actual y le explicamos sus opciones — para casa, auto y cada línea que manejamos. Solo recomendamos un cambio si realmente le conviene.' },
  ...
  services: {
    ...
    intro: 'Nos tomamos el tiempo de explicarle la cobertura de su hogar para que sepa exactamente qué tiene. Para su auto, su negocio y las personas que dependen de usted, también nos aseguramos de que tenga la protección correcta.',
    metaTitle: 'Seguro de Auto, Casa y Comercial en Florida | M&K Agency',
    metaDesc: 'Seguro de casa, auto, condominio, comercial y vida de una agencia familiar en Florida City. Llame al (305) 859-3953.',
    auto: { h: 'Seguro de Auto', p: 'Los conductores de Florida pagan algunas de las tarifas más altas del país. Le explicamos exactamente qué cubre su póliza — responsabilidad civil, cobertura completa, SR-22, rideshare y más. Prueba de seguro el mismo día.' },
    home: { h: 'Seguro de Casa y Condominio', p: 'Huracanes, inundaciones y primas en aumento hacen complicado el seguro de vivienda en Florida. Le ayudamos a proteger su mayor inversión y a entender exactamente qué cubre su póliza — incluyendo orientación sobre mitigación de viento e inspección de cuatro puntos.' },
    commercial: { h: 'Seguro Comercial', p: 'Desde responsabilidad civil general y compensación laboral hasta auto comercial — ayudamos a proteger a contratistas, restaurantes, camioneros y pequeños negocios en toda la Florida.' },
    ...
    specialty: { h: 'Otros Seguros Privados', p: 'Seguro de embarcaciones, motocicletas, carritos de golf, mascotas y otra cobertura que las pólizas estándar no incluyen.' },
    cta: 'Una sola llamada lo resuelve todo — un agente licenciado le explica sus opciones.',
  },
  about: {
    metaTitle: 'Sobre M&K Agency | Agencia de Seguros Familiar en Florida City, FL',
    metaDesc: 'M&K Agency Inc. es una agencia de seguros familiar y bilingüe en Florida City que sirve a toda la Florida. Agentes licenciados reales, atención en inglés, español y ruso. Llame al (305) 859-3953.',
  ...
  contact: {
    metaTitle: 'Contacte a M&K Agency | Hable con un Agente | (305) 859-3953 ',
  ...
  referral: {
    ...
    errorMessage: 'Algo salió mal. Llámenos al (305) 859-3953.',
  ...
  chat: {
    ...
    title: 'Nick AI',
    greeting: '¡Hola! Soy Nick, el asistente de IA de M&K Agency. Pregúnteme lo que quiera sobre seguros de auto, casa o negocio en Florida — o deje su número y un agente licenciado le devolverá la llamada.',
    ...
    cbSubmit: 'Llámenme',
    cbSending: 'Enviando...',
    cbOk: '¡Listo! Le llamaremos en horario de oficina — lun–vie, 9am–6pm ET.',
    errMsg: 'Algo salió mal. Llámenos al (305) 859-3953.',
  },
  quoteForm: {
    title: 'Hable con un agente licenciado sobre {product}',
    sub: 'Toma alrededor de un minuto. Un agente licenciado le devuelve la llamada en horario de oficina (lun–vie, 9am–6pm ET).',
    name: 'Nombre completo',
    phone: 'Teléfono',
    email: 'Correo electrónico (opcional)',
    address: 'Dirección o código postal (opcional)',
    businessName: 'Nombre del negocio (opcional)',
    businessType: 'Tipo de negocio (opcional)',
    businessTypePh: 'ej. jardinería, restaurante, transporte de carga',
    vehicles: 'Número de vehículos (opcional)',
    vin: 'VIN (opcional)',
    vinPh: 'VIN de 17 caracteres',
    drivers: 'Número de conductores (opcional)',
    comments: '¿Algo más que debamos saber? (opcional)',
    commentsPh: 'ej. coberturas que desea, fecha de renovación de su póliza actual',
    commentsPhCommercial: 'ej. a qué se dedica el negocio, fecha de renovación de su póliza actual, requisitos de contratos',
    submit: 'Solicitar mi llamada →',
    sending: 'Enviando...',
    consentNeeded: 'Por favor, marque la casilla de consentimiento para que podamos contactarle.',
    ok: 'Gracias. Un agente licenciado le llamará en horario de oficina — lun–vie, 9am–6pm ET.',
    err: 'Algo salió mal. Por favor, llámenos al (305) 859-3953.',
    privacy: 'Su información es privada. Nunca le enviaremos spam.',
  },
  productPage: {
    h1Suffix: 'en Florida',
    callCta: 'Llame al',
    textCta: 'Envíenos un texto',
    hours: 'Lun–Vie 9am–6pm ET',
    trustTitle: 'Agentes locales, licenciados y fáciles de contactar',
    office: 'Oficina',
  ...
  talkNow: {
    ...
    title: '¿Tiene preguntas sobre su cobertura?',
    sub: 'Pida que un agente licenciado le llame o le envíe un texto.',
    callMe: '📞 Llámenme',
    textMe: '💬 Envíenme un texto',
    name: 'Su nombre',
    phone: 'Su número de teléfono',
    agent: '¿Prefiere un agente en particular? (opcional)',
    agentAny: 'Sin preferencia — cualquier agente disponible',
    close: 'Cerrar',
    requestCall: 'Solicitar una llamada →',
    requestText: 'Solicitar un texto →',
    sending: 'Enviando...',
    okCall: '¡Listo! Un agente le llamará en horario de oficina — lun–vie, 9am–6pm ET.',
  ...
  footerExtra: {
    ...
    allstateBefore: 'Visite mi sitio, ',
    allstateLink: 'Allstate Agency - Mikhail Kozlov',
    allstateAfter: ', para obtener más información sobre los productos y servicios de Allstate que puedo ofrecerle.',
  },
  footer: {
    lic: 'M&K Agency Inc. · Agencia de Seguros Familiar · Servimos toda la Florida',
...
const ru: typeof en = {
  ...
  hero: {
    ...
    strip: 'Страхование дома, авто, бизнеса и жизни — понятно объясняет лицензированный местный агент, всё в одном месте.',
  },
  homeFaq: {
    ...
    items: [
      ...
      { q: 'Нужно ли отменять текущий полис, чтобы просто поговорить с вами?', a: 'Нет. Мы вместе с вами разберём ваше текущее покрытие и объясним варианты — по дому, авто и любому другому виду страхования, которым занимаемся. Менять полис советуем, только если это реально выгодно.' },
  ...
  form: {
    ...
    zip: 'ZIP-код', name: 'Полное имя', phone: 'Телефон', email: 'Email (необязательно)',
    ...
    sending: 'Отправка...',
    ok: 'Спасибо! Лицензированный агент перезвонит в рабочие часы — Пн–Пт, 9:00–18:00 ET. Нужен ответ раньше? Спросите Ника, нашего ИИ-ассистента, в чате.',
  ...
  services: {
    ...
    intro: 'Мы уделяем время тому, чтобы объяснить страхование вашего дома, чтобы вы точно знали, что у вас есть. Для вашего автомобиля, бизнеса и людей, которые зависят от вас, мы тоже позаботимся о правильной защите.',
    metaTitle: 'Страхование авто, дома и бизнеса во Флориде | M&K Agency',
    metaDesc: 'Страхование дома, авто, кондо, бизнеса и жизни. Семейное агентство в Florida City, работаем по всей Флориде. Звоните: (305) 859-3953.',
    auto: { h: 'Автострахование', p: 'Водители Флориды платят одни из самых высоких тарифов в стране. Объясним, что именно покрывает ваш полис — liability, полное покрытие, SR-22, rideshare и другое. Подтверждение страховки в тот же день.' },
    home: { h: 'Страхование дома и кондо', p: 'Ураганы, наводнения и растущие тарифы делают страхование жилья во Флориде сложным. Мы поможем защитить вашу главную инвестицию и понять, что именно покрывает ваш полис — включая помощь с wind mitigation и four-point inspection.' },
    commercial: { h: 'Страхование бизнеса', p: 'От general liability и workers\u2019 comp до коммерческого авто — помогаем защитить подрядчиков, рестораны, дальнобойщиков и малый бизнес по всей Флориде.' },
    ...
    specialty: { h: 'Другие виды частного страхования', p: 'Страхование лодок, мотоциклов, гольф-каров, домашних животных и другое покрытие, которое обычно не входит в стандартные полисы.' },
    cta: 'Достаточно одного звонка — лицензированный агент объяснит все варианты.',
  },
  about: {
    metaTitle: 'О компании M&K Agency | Семейное страховое агентство во Флориде',
    metaDesc: 'M&K Agency Inc. — семейное страховое агентство в Florida City, работающее по всей Флориде. Живые лицензированные агенты, обслуживание на русском, английском и испанском. Говорим по-русски: (305) 859-3953.',
  ...
  contact: {
    metaTitle: 'Контакты M&K Agency | Поговорите с агентом | (305) 859-3953',
  ...
  referral: {
    ...
    errorMessage: 'Что-то пошло не так. Позвоните нам: (305) 859-3953.',
  ...
  chat: {
    ...
    title: 'Nick AI',
    greeting: 'Здравствуйте! Я Ник, ИИ-ассистент M&K Agency. Задайте любой вопрос о страховании авто, дома или бизнеса во Флориде — или оставьте номер, и лицензированный агент вам перезвонит.',
    ...
    cbSending: 'Отправка...',
    cbOk: 'Принято! Мы перезвоним в рабочие часы — Пн–Пт, 9:00–18:00 ET.',
    errMsg: 'Что-то пошло не так. Позвоните нам: (305) 859-3953.',
  },
  quoteForm: {
    title: 'Поговорите с лицензированным агентом: {product}',
    sub: 'Займёт около минуты. Лицензированный агент перезвонит в рабочие часы (Пн–Пт 9:00–18:00 ET).',
    name: 'Полное имя',
    phone: 'Телефон',
    email: 'Email (необязательно)',
    address: 'Адрес или ZIP-код (необязательно)',
    businessName: 'Название компании (необязательно)',
    businessType: 'Вид деятельности (необязательно)',
    businessTypePh: 'напр. ландшафтные работы, ресторан, грузоперевозки',
    vehicles: 'Количество машин (необязательно)',
    vin: 'VIN (необязательно)',
    vinPh: 'VIN из 17 символов',
    drivers: 'Количество водителей (необязательно)',
    comments: 'Что-то ещё, что нам стоит знать? (необязательно)',
    commentsPh: 'напр. нужные покрытия, дата продления текущего полиса',
    commentsPhCommercial: 'напр. чем занимается бизнес, дата продления полиса, требования контрактов',
    submit: 'Заказать обратный звонок →',
    sending: 'Отправка...',
    consentNeeded: 'Отметьте согласие выше, чтобы мы могли с вами связаться.',
    ok: 'Спасибо! Лицензированный агент перезвонит в рабочие часы — Пн–Пт, 9:00–18:00 ET.',
    err: 'Что-то пошло не так. Позвоните нам: (305) 859-3953.',
    privacy: 'Ваши данные конфиденциальны. Никакого спама.',
  },
  productPage: {
    h1Suffix: 'во Флориде',
    callCta: 'Позвонить',
    textCta: 'Написать SMS',
    hours: 'Пн–Пт 9:00–18:00 ET',
    trustTitle: 'Местные лицензированные агенты — всегда на связи в рабочие часы',
    office: 'Офис',
  ...
  talkNow: {
    ...
    title: 'Есть вопрос о вашем покрытии?',
    sub: 'Закажите звонок или SMS от лицензированного агента.',
    callMe: '📞 Позвоните мне',
    textMe: '💬 Напишите мне',
    name: 'Ваше имя',
    phone: 'Ваш номер телефона',
    agent: 'Хотите конкретного агента? (необязательно)',
    agentAny: 'Без предпочтений — любой свободный агент',
    close: 'Закрыть',
    requestCall: 'Заказать звонок →',
    requestText: 'Заказать SMS →',
    sending: 'Отправка...',
  ...
  footerExtra: {
    ...
    // Left in English on /ru (unchanged from before); ES translation is
    // pending Allstate compliance review, see PR notes.
    allstateBefore: 'Please visit my site, ',
    allstateLink: 'Allstate Agency - Mikhail Kozlov',
    allstateAfter: ', to get more information on the Allstate products and services I can offer.',
  },
  footer: {
    lic: 'M&K Agency Inc. · Семейное страховое агентство · Работаем по всей Флориде',
