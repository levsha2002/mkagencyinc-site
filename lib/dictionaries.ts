...
const en = {
  ...
  services: {
    ...
    commercial: { h: 'Commercial Insurance', p: 'From general liability and workers\u2019 comp to commercial auto and BOP policies — we protect contractors, restaurants, truckers, and small businesses across Florida.' },
  ...
  about: {
    ...
    metaDesc: 'M&K Agency Inc. is a bilingual family-owned insurance agency in Florida City serving all of Florida. Real licensed agents, service in English, Spanish and Russian, rated 4.53★ from 68 verified client reviews. Call (305) 859-3953.',
    ...
    points: ['Home, auto, commercial & life coverage in one place', 'English · Español · Русский', 'Rated 4.53★ from 68 verified client reviews', 'Local office — real agents, not a national call center'],
    visit: 'Visit us',
  },
  contact: {
...
const es: typeof en = {
  ...
  services: {
    ...
    commercial: { h: 'Seguro Comercial', p: 'Desde responsabilidad general y compensación laboral hasta auto comercial y pólizas BOP — protegemos contratistas, restaurantes, camioneros y pequeños negocios en toda la Florida.' },
  ...
  about: {
    ...
    metaDesc: 'M&K Agency Inc. es una agencia de seguros familiar y bilingüe en Florida City que sirve a toda la Florida. Agentes licenciados reales, atención en inglés, español y ruso, calificación 4.53★ de 68 reseñas verificadas de clientes. Llame al (305) 859-3953.',
    ...
    points: ['Cobertura de casa, auto, comercial y vida en un solo lugar', 'English · Español · Русский', 'Calificación 4.53★ de 68 reseñas verificadas de clientes', 'Oficina local — agentes reales, no un call center nacional'],
    visit: 'Visítenos',
  },
  contact: {
...
const ru: typeof en = {
  ...
  services: {
    ...
    commercial: { h: 'Страхование бизнеса', p: 'От general liability и workers\u2019 comp до коммерческого авто и полисов BOP — мы защищаем подрядчиков, рестораны, дальнобойщиков и малый бизнес по всей Флориде.' },
  ...
  about: {
    ...
    metaDesc: 'M&K Agency Inc. — семейное страховое агентство в Florida City, работающее по всей Флориде. Живые лицензированные агенты, обслуживание на русском, английском и испанском, рейтинг 4.53★ по 68 проверенным отзывам клиентов. Говорим по-русски: (305) 859-3953.',
    ...
    points: ['Страхование дома, авто, бизнеса и жизни в одном месте', 'English · Español · Русский', 'Рейтинг 4.53★ по 68 проверенным отзывам клиентов', 'Локальный офис — живые агенты, а не национальный колл-центр'],
    visit: 'Наш офис',
  },
  contact: {
