...
// Client UI for /[lang]/quote. app/[lang]/quote/page.tsx (server) renders it and
// passes the server-rendered RatingBadge in as a prop.
export default function ContactAgentsPage({ ratingBadge }: { ratingBadge?: React.ReactNode }) {
    ...
    <main className="qh">
      ...
      <div className="qh-navy">
        ...
        <div className="qh-hero">
          ...
          {ratingBadge ? <div className="qh-rating">{ratingBadge}</div> : null}
