...
const C: Record<Lang, any> = {
  en: {
    ...
    metaDesc:
      'Local independent agents compare 15+ A-rated carriers for auto insurance in Florida City & Homestead. Free quote in minutes — English, Español, по-русски.',
    kicker: 'Auto Insurance · Florida City & Homestead',
    h1a: 'Car insurance in Florida City & Homestead,',
    h1b: 'without overpaying.',
    sub: 'Your neighbors on S Dixie Hwy compare 15+ A-rated carriers for you — Progressive, Bristol West, Mercury and more. One call, three languages, real local agents.',
    ...
    whyText:
      'Miami-Dade drivers pay some of the highest auto premiums in Florida: dense traffic on US-1 and the Turnpike, high uninsured-driver rates, and storm exposure all push prices up. A single carrier can only offer you its own rate. As an independent agency in Florida City, we shop your profile across 15+ carriers and apply every discount you qualify for — so you see the real market, not one company’s price.',
    ...
    faq: [
      ...
      { q: 'Why is car insurance so expensive in Miami-Dade County?', a: 'High traffic density, one of the highest uninsured-driver rates in the country, storm exposure, and litigation costs all raise premiums. Comparing multiple carriers is the most effective way to avoid overpaying.' },
      { q: 'Can you insure drivers with a foreign or international license?', a: 'Yes. Several of our carriers accept foreign licenses. We work with newcomers every week in English, Spanish, and Russian, and explain every step of the process.' },
      ...
      { q: 'Do you charge a fee for quotes?', a: 'No. Quotes are free and there is no obligation. We are paid by the carrier you choose, and comparing does not affect your credit score.' },
    ],
  ...
  es: {
    ...
    metaDesc:
      'Agentes locales independientes comparan 15+ aseguradoras A-rated para su seguro de auto en Florida City y Homestead. Cotización gratis en minutos. Hablamos español.',
    kicker: 'Seguro de Auto · Florida City y Homestead',
    h1a: 'Seguro de auto en Florida City y Homestead,',
    h1b: 'sin pagar de más.',
    sub: 'Sus vecinos en S Dixie Hwy comparan 15+ aseguradoras A-rated por usted — Progressive, Bristol West, Mercury y más. Una llamada, tres idiomas, agentes locales de verdad.',
    ...
    whyText:
      'Los conductores de Miami-Dade pagan algunas de las primas más altas de Florida: tráfico denso en la US-1 y el Turnpike, alto porcentaje de conductores sin seguro y exposición a tormentas. Una sola compañía solo puede ofrecerle su propia tarifa. Como agencia independiente en Florida City, comparamos su perfil en 15+ aseguradoras y aplicamos cada descuento que le corresponde — usted ve el mercado real, no el precio de una sola compañía.',
    ...
    faq: [
      ...
      { q: '¿Por qué el seguro es tan caro en el condado de Miami-Dade?', a: 'Tráfico denso, uno de los porcentajes más altos de conductores sin seguro del país, exposición a tormentas y costos legales elevan las primas. Comparar varias aseguradoras es la forma más eficaz de no pagar de más.' },
      { q: '¿Aseguran a conductores con licencia extranjera?', a: 'Sí. Varias de nuestras aseguradoras aceptan licencias extranjeras. Trabajamos con recién llegados cada semana, en inglés, español y ruso.' },
      ...
      { q: '¿Cobran por cotizar?', a: 'No. Las cotizaciones son gratis y sin compromiso. Nos paga la aseguradora que usted elija, y comparar no afecta su puntaje de crédito.' },
    ],
  ...
  ru: {
    ...
    metaDesc:
      'Местные независимые агенты сравнят 15+ страховых A-rated для вашей автостраховки во Florida City и Homestead. Бесплатный расчёт за минуты. Говорим по-русски.',
    kicker: 'Автостраховка · Florida City и Homestead',
    h1a: 'Автостраховка во Florida City и Homestead —',
    h1b: 'без переплаты.',
    sub: 'Ваши соседи с S Dixie Hwy сравнят за вас 15+ страховых A-rated — Progressive, Bristol West, Mercury и другие. Один звонок, три языка, настоящие местные агенты.',
    ...
    whyText:
      'Водители Miami-Dade платят одни из самых высоких премий во Флориде: плотный трафик на US-1 и Turnpike, высокая доля незастрахованных водителей и ураганы поднимают цены. Одна компания может предложить только свой тариф. Как независимое агентство во Florida City, мы прогоняем ваш профиль по 15+ страховым и применяем каждую положенную скидку — вы видите весь рынок, а не цену одной компании.',
    ...
    faq: [
      ...
      { q: 'Почему страховка в Miami-Dade такая дорогая?', a: 'Плотный трафик, один из самых высоких в стране процентов незастрахованных водителей, ураганы и судебные издержки поднимают премии. Сравнение нескольких страховых — самый эффективный способ не переплачивать.' },
      { q: 'Страхуете ли водителей с иностранными правами?', a: 'Да. Несколько наших страховых принимают иностранные права. Мы каждую неделю помогаем новоприбывшим — на английском, испанском и русском.' },
      ...
      { q: 'Расчёт платный?', a: 'Нет. Расчёты бесплатны и ни к чему не обязывают. Нам платит страховая, которую вы выберете, а сравнение не влияет на кредитный рейтинг.' },
    ],
