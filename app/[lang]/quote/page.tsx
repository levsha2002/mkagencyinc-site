...
const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    h1: 'Get your free quote', sub: 'Pick what you need — then a real, local agent calls you back.',
    ...
    pickFirst: 'Choose an option above to start your quote.',
  ...
  es: {
    ...
    h1: 'Obtén tu cotización gratis', sub: 'Elige lo que necesitas — un agente local te devuelve la llamada.',
    ...
    pickFirst: 'Elige una opción arriba para comenzar tu cotización.',
  ...
  ru: {
    ...
    h1: 'Получите бесплатный расчёт', sub: 'Выберите, что нужно — местный агент перезвонит вам.',
    ...
    pickFirst: 'Выберите вариант выше, чтобы начать расчёт.',
