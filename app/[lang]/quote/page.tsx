...
const UI: Record<Lang, Record<string, string>> = {
  ...
  es: {
    ...
    consent: 'Acepto que M&K Agency puede contactarme por teléfono, mensaje de texto o correo electrónico al número proporcionado sobre seguros, incluso si está en una lista de No Llamar. El consentimiento no es una condición de compra. Pueden aplicarse tarifas de mensajes/datos.',
  ...
  ru: {
    ...
    consent: 'Я согласен(на), что M&K Agency может связаться со мной по телефону, SMS или электронной почте по указанному номеру по вопросам страхования, даже если номер внесён в список «Не звонить». Согласие не является условием покупки. Может взиматься плата за сообщения/данные.',
...
.qh-agent img{width:88px;height:88px;border-radius:50%;object-fit:cover;border:3px solid #e0a93b;display:block;margin:0 auto 8px;background:#e8f1fc;box-shadow:0 6px 16px rgba(7,39,79,.12)}
.qh-agent-name{font-size:17px;font-weight:800;color:#07274f}
